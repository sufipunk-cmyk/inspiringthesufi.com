...
/**
 * Quiet rectangular panel used to frame the form (and the post-submit
 * thank-you state). Deliberately *not* the Alcove component — the
 * alcove's crown is aspect-locked and at the form's container width
 * (max-w-xl ≈ 576 px) it would render as a ~400 px-tall empty lancet
 * dominating the whole page. The alcove vocabulary belongs to the
 * archive's narrow index cards; on this page the form is the active
