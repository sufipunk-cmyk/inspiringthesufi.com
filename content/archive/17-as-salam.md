...
oldPath: "/inspiring-the-sufi-blog/2016/3/23/4544k23bxocjnbwkurnd2oqcnrrg18"
oldPostId: "39"

narrativeReviewNeeded: false
hasReplacedYouTube: false
...
comments:
  - id: "19"
    parentId: null
    author: "perveen"
    date: "2016-03-30 07:57:25"
    bodyMarkdown: |
      Truley beautiful, touched my soul....thank you as always for sharing the music and wisdom ....x
  - id: "23"
    parentId: "19"
    author: "Sufi Punk"
    date: "2016-03-30 08:19:37"
    bodyMarkdown: |
      :) xx
  - id: "20"
    parentId: null
    author: "Liz"
    date: "2019-10-16 22:02:49"
    bodyMarkdown: |
      So glad you posted this, thank you.  
      I just wanted to tell it doesn'matter which religion you are, it shouldn't be a " Being from a Muslim background I know it should bother me that she sings from the sikh faith..." bother you? why should you make a distinction in between souls ? Different paths according to whst suits you better. Glad you didn't care but don't let any religion limit yourself. We all are one.
  - id: "21"
    parentId: null
    author: "Deb"
    date: "2021-02-24 04:03:18"
    bodyMarkdown: |
      Ahhhhhhh........sigh.....
  - id: "22"
    parentId: null
    author: "Monica Deschamps"
    date: "2022-02-28 17:36:06"
    bodyMarkdown: |
...
**Waheguru** ([Punjabi](https://en.wikipedia.org/wiki/Punjabi_language): _vāhigurū_) is a term most often in [Sikhism](https://en.wikipedia.org/wiki/Sikhism) to refer to [God](https://en.wikipedia.org/wiki/God), the [Supreme Being](https://en.wikipedia.org/wiki/Supreme_Being) or the creator of all. It means "Wonderful Teacher" in the Punjabi language, but in this case is used to refer to God. _Vāhi_ (a Middle Persian borrowing) means "wonderful" and [_guru_](https://en.wikipedia.org/wiki/Guru) ([Sanskrit](https://en.wikipedia.org/wiki/Sanskrit_language): _guru_) is a term denoting "teacher". Waheguru is also described by some as an experience of ecstasy which is beyond all descriptions. The most common usage of the word "Waheguru" is in the greeting Sikhs use with each other:

**Satnam** ([Gurmukhi](https://en.wikipedia.org/wiki/Gurmukhi):ਸਤਿ ਨਾਮੁ ) is the main word that appears in the [Sikh](https://en.wikipedia.org/wiki/Sikh) sacred [scripture](https://en.wikipedia.org/wiki/Scripture) called the [Guru Granth Sahib](https://en.wikipedia.org/wiki/Guru_Granth_Sahib). It is part of the [Gurbani](https://en.wikipedia.org/wiki/Gurbani) [shabad](https://en.wikipedia.org/wiki/Shabda) called [Mool Mantra](https://en.wikipedia.org/wiki/Mool_Mantra) which is repeated daily by all Sikhs. This word succeeds the word "[Ek-onkar](https://en.wikipedia.org/wiki/Ik_Onkar)" which means "There is only one constant" or commonly "There is one God". The words _sat_ means "true/everlasting" and _nam_ means "name".\[1\] In this instance, this would mean, "whose name is truth".\[2\]

The word _nam_ in Sikhism has two meanings. "It meant both an application and a symbol of the All-pervading Supreme Reality that sustained the universe. [Guru Nanak](https://en.wikipedia.org/wiki/Guru_Nanak) in his teachings emphasized the need of repeating Sat-Nam to realize the All-pervading Supreme Reality.
